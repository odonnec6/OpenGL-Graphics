...
{
   glViewport (200, 150, 400,300); //Lab 1 Q2 - making triangle appear half size without changing the vertices by changing the size of the viewport, setting width and height of viewport and centralising it
}
...
int main(int argc, char** argv){
	...
	glutReshapeFunc(reshape);	// Lab 1 q2 - Call to reshape function
